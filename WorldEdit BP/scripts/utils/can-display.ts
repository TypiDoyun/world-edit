...
export const canDisplay = (player: Player, vector: Vector3, distanceLimit: number) => {
    ...
    if (distanceSquared > distanceLimit ** 2) return false;
    ...
    if (rightResult > 0 || leftResult < 0) return false;
